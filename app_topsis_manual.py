# Streamlit TOPSIS-Only Tool (Weights from Manual AHP)
...
st.success("✅ TOPSIS prioritization completed. You can now use this tool for policy evaluation or planning.")